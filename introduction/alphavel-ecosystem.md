...
| `alphavel/rate-limit` | Swoole Table limiting | 15 KB | +0.8ms |
...
| `alphavel/queue` | Async job queue | ~30 KB | +0.5ms | 🔄 TIER 1 |
| `alphavel/mail` | Email sending | ~20 KB | +1ms | 🔄 TIER 1 |
| `alphavel/session` | Session management | ~18 KB | +0.01ms | 🔄 TIER 1 |
| `alphavel/view` | Blade templates | ~35 KB | +5ms | 🔄 TIER 1 |
| `alphavel/i18n` | Translations | ~12 KB | +0.1ms | 🔄 TIER 1 |
| `alphavel/testing` | Test utilities | ~25 KB | N/A (dev) | 🔄 TIER 1 |
| `alphavel/orm` | Advanced ORM | ~40 KB | +1ms | 🔄 TIER 1 |
